...
Read and preprocess all questions in VQA 2.0 Dataset, and create dictionary (for initializing embeddings). Additionally
...
def vqa2_create_dictionary_glove(vqa2_q='data/VQA2-Questions', glove='data/glove/glove.6B.300d.txt',
